...
GAME_MAP += [
        ...
        ["The science lab", 13, 13, False, False], # room 34
        ...
        ["Securit portal to Mission COntrol", 7, 7, True, False], # room 45
...
objects = {
    ...
    4: [images.bed, images.half_shadow, "A tidy comfortable bed"],
    ...
    11: [images.desk_computer, iages.half_shadow, "A computer. Use it to run life support diagnostics"],
...
# using room data, scenery data and prop data.
    ...
    if current_room % MAP_WIDTH != 1: # If the room is not on the left of the map.
